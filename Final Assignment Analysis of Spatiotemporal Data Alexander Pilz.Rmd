...
plot(densityArnsberg, main = "Wind turbine density - Arnsberg", sub = "Fig. ", box=FALSE)
...
plot(densityDetmold, main = "Wind turbine density - Detmold", sub = "Fig. ", box=FALSE)
...
plot(densityKöln, main = "Wind turbine density - Köln", sub = "Fig. ", box=FALSE)
...
plot(densityDüsseldorf, main = "Wind turbine density - Düsseldorf", sub = "Fig. ", box=FALSE)
...
plot(densityMünster, main = "Wind turbine density of Münster precinct", sub = "Fig. ", box=FALSE)
...
```
```{r plotLocalDensities, echo=FALSE, fig.show='hold', message=FALSE, warning=FALSE, out.width='50%'}
...
plot(effectfun(ppmArnsbergCov, "covariantArnsberg", se.fit=TRUE), main=NULL, las=1)
plot(ppmArnsbergPred, box=FALSE)

plot(effectfun(ppmDetmoldCov, "covariantDetmold", se.fit=TRUE), main=NULL, las=1)
plot(ppmDetmoldPred, box=FALSE)

plot(effectfun(ppmKölnCov, "covariantKöln", se.fit=TRUE), main=NULL, las=1)
plot(ppmKölnPred, box=FALSE)

plot(effectfun(ppmDüsseldorfCov, "covariantDüsseldorf", se.fit=TRUE), main=NULL, las=1)
plot(ppmDüsseldorfPred, box=FALSE)

plot(effectfun(ppmMünsterCov, "covariantMünster", se.fit=TRUE), main=NULL, las=1)
plot(ppmMünsterPred, box=FALSE)
```
